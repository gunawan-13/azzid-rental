...
function renderA() {
  ...
  app.innerHTML = `<div class="min-h-screen bg-ink-950 flex">
    ...
    <div class="flex-1 flex flex-col min-w-0 min-h-0">
      <header class="h-16 bg-ink-900/80 backdrop-blur border-b border-white/5 flex items-center gap-3 px-4 sm:px-6 sticky top-0 z-30" style="position:sticky!important;top:0!important">
